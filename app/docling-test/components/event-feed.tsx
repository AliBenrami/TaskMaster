      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h3 className="mt-2 text-xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">
            Saved Docling event feed
          </h3>
          <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
            Every explicit calendar-dated item normalized from the current docling-test run.
          </p>
        </div>
      ...
      <div className="mt-4 space-y-3">
        {events.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-zinc-300 px-4 py-6 text-sm leading-6 text-zinc-500 dark:border-zinc-700 dark:text-zinc-400">
            No saved event feed yet. Upload a document with explicit calendar dates to populate this list
            and enable export.
          </div>
        )}
      </div>
